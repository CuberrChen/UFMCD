...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=5000,
        help='The semi-training after semi start iter. If label_ratio is not None, use semi training method.' \
             'and need to use --ssl_method to select semi-training gmethod'
    )
    parser.add_argument(
        '--device',
...
def main(args):
    ...
    place = 'gpu:{}'.format(args.device) if args.device is not None else place
    ...
    if args.label_ratio is not None:
        ...
        train_ssl(
            ...
            ssl_method=args.ssl_method.upper(),
            semi_start_iter = args.semi_start_iter,
            ...
            to_static_training=cfg.to_static_training, case=args.device)
